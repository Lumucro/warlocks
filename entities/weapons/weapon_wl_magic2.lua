...
function SWEP:SecondaryAttack()
	...
	if SERVER then
		...
		local melonmine = ents.Create( "wl_magic_melonmine" )
		melonmine :SetOwner( self.Owner )
		melonmine :SetPos( self.Owner:GetPos() )
		...
		melonmine:SetAngles( magicangle )
		melonmine:SetPos( magicpos )
		melonmine:Spawn()
